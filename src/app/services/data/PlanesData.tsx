...
const planesData: PlanData[] = [
  {
    ...
    description:
      'Ideal para proyectos pequeños que requieren reportes esenciales y visualizaciones simples.',
    details: {
      ...
      'Modelos Predictivos': '❌',
      'Soporte de Machine Learning': '❌',
      'Automatización de Reportes': '❌',
    },
    features: {
      'Número de Reportes': '1',
  ...
  },
  {
    ...
    description:
      'Perfecto para empresas que buscan profundizar en sus datos con análisis detallados y dashboards interactivos.',
    details: {
      'Visualización de Datos': '✅',
      'Informe Ejecutivo': '✅',
      'Dashboard Interactivo': '✅',
  ...
  },
  {
    ...
    description:
      'Ideal para organizaciones consolidadas que buscan una solución completa con análisis avanzados, machine learning y automatización de reportes.',
    details: {
      'Visualización de Datos': '✅',
      'Informe Ejecutivo': '✅',
      'Dashboard Interactivo': '✅',
...
const PlanesData = () => {
  return (
    <section className="relative min-h-screen py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-hidden mt-10">
      {/* Se agrega pointer-events-none para que este elemento no capture los clics */}
      <div className="absolute inset-0 opacity-5 pointer-events-none dark:opacity-[0.02] bg-[url('/grid.svg')] bg-repeat" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Transformamos tus datos en insights accionables con tecnología de
            punta y metodologías analíticas de vanguardia.
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
            ¿Tienes necesidades específicas de análisis de datos o buscas una
